...
public class WebSocketAuthInterceptor implements ChannelInterceptor {
    ...
    public Message<?> preSend(Message<?> message, MessageChannel channel) {
        ...
        if (accessor != null) {
            ...
            if (StompCommand.CONNECT.equals(command)) {
            ...
            } else if (command != null && (StompCommand.SEND.equals(command) || StompCommand.SUBSCRIBE.equals(command))) {
                ...
                if (userPrincipal instanceof Authentication) {
                    ...
                    log.debug("Đã set Authentication vào SecurityContextHolder cho message {} từ user: {}", 
                            command, auth.getName());
                } else {
                    ...
                    if (authHeaders != null && !authHeaders.isEmpty()) {
                        ...
                        if (authHeader != null && authHeader.startsWith("Bearer ")) {
                            ...
                            try {
                                ...
                                accessor.setUser(authentication);
                                SecurityContextHolder.getContext().setAuthentication(authentication);
                                log.debug("Đã set Authentication từ header vào SecurityContextHolder cho message {} từ user: {}", 
                                        command, jwt.getSubject());
                            } catch (Exception e) {
                        ...
                        log.warn("Message {} không có Authentication từ Principal và không có Authorization header", command);
