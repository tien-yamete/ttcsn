...
public class FollowController {
    ...
    ApiResponse<FollowResponse> followUser(@PathVariable String followingId) {
        String followerId =
    ...
    ApiResponse<Void> unfollowUser(@PathVariable String followingId) {
        String followerId =
                SecurityContextHolder.getContext().getAuthentication().getName();
    ...
    ApiResponse<UserSocialInfoResponse> getUserSocialInfo(@PathVariable String userId) {
